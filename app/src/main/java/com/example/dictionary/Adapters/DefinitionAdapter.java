...
import com.example.dictionary.Models.Defenitions;
...
public class DefinitionAdapter extends RecyclerView.Adapter<DefinitionViewHolder> {
    ...
    private List<Defenitions> definitionsList;

    public DefinitionAdapter(Context context, List<Defenitions> definitionsList) {
